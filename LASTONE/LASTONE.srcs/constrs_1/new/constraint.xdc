...
##Switches
#set_property -dict { PACKAGE_PIN "A3"		IOSTANDARD LVCMOS33		SLEW FAST} [get_ports {red[0]}]	
#set_property -dict { PACKAGE_PIN "B4"		IOSTANDARD LVCMOS33		SLEW FAST} [get_ports {red[1]}]	
#set_property -dict { PACKAGE_PIN "C5"		IOSTANDARD LVCMOS33		SLEW FAST} [get_ports {red[2]}]	
#set_property -dict { PACKAGE_PIN "C6"		IOSTANDARD LVCMOS33		SLEW FAST} [get_ports {green[0]}]	
#set_property -dict { PACKAGE_PIN "A5"		IOSTANDARD LVCMOS33		SLEW FAST} [get_ports {green[1]}]	
#set_property -dict { PACKAGE_PIN "B6"		IOSTANDARD LVCMOS33		SLEW FAST} [get_ports {green[2]}]	
#set_property -dict { PACKAGE_PIN "B7"		IOSTANDARD LVCMOS33		SLEW FAST} [get_ports {blue[0]}]	
#set_property -dict { PACKAGE_PIN "C7"		IOSTANDARD LVCMOS33		SLEW FAST} [get_ports {blue[1]}]	
#set_property -dict { PACKAGE_PIN "B11"		IOSTANDARD LVCMOS33		SLEW FAST} [get_ports {hsync}]	
#set_property -dict { PACKAGE_PIN "B12"		IOSTANDARD LVCMOS33		SLEW FAST} [get_ports {vsync}]	
...
#set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { sobel_light[0] }]; #IO_L8P_T1_D11_14 Sch=led[3]
#set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { sobel_light[1] }]; #IO_L7P_T1_D09_14 Sch=led[4]
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { sobel_light[2] }]; #IO_L18N_T2_A11_D27_14 Sch=led[5]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { sobelready}]; #IO_L17P_T2_A14_D30_14 Sch=led[6]
#set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { sobel_light[4] }]; #IO_L18P_T2_A12_D28_14 Sch=led[7]
...
#set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { dv }]; #IO_L20N_T3_A07_D23_14 Sch=led[14]
#set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { width_light[1] }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
