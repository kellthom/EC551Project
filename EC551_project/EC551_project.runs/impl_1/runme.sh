...
HD_PWD='C:/Users/XTYAO/Desktop/551Final/EC551Project/EC551_project/EC551_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_on_board_testing.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_on_board_testing.tcl -notrace
