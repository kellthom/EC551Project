...
#
# Script generated by Vivado on Mon Dec 11 15:51:19 -0500 2023
...
#
# Usage        : BRAM.sh
#                BRAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                BRAM.sh [-reset_run]
#                BRAM.sh [-reset_log]
#                BRAM.sh [-help]
#
...
# script info
echo -e "BRAM.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./BRAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot BRAM xil_defaultlib.BRAM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim BRAM -key {Behavioral:sim_4:Functional:BRAM} -tclbatch cmd.tcl -protoinst "protoinst_files/BRAM.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BRAM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./BRAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: BRAM.sh [-help]\n\
Usage: BRAM.sh [-step]\n\
Usage: BRAM.sh [-lib_map_path]\n\
Usage: BRAM.sh [-reset_run]\n\
Usage: BRAM.sh [-reset_log]\n\
Usage: BRAM.sh [-keep_index]\n\
Usage: BRAM.sh [-noclean_files]\n\n\
